...
export class WasmEmu {
    ...
    static __wrap(ptr) {
        const obj = Object.create(WasmEmu.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_wasmemu_free(ptr);
    }
    /**
    */
    constructor() {
        const ret = wasm.wasmemu_default();
        return WasmEmu.__wrap(ret);
    }
    /**
    */
    reset() {
        wasm.wasmemu_reset(this.ptr);
    }
    /**
    */
    exec() {
        wasm.wasmemu_exec(this.ptr);
    }
    /**
    */
    tick_timers() {
        wasm.wasmemu_tick_timers(this.ptr);
    }
    /**
    ...
    */
    key_press(event, pressed) {
        wasm.wasmemu_key_press(this.ptr, addHeapObject(event), pressed);
    }
    /**
    * @param {Uint8Array} data
    */
    load(data) {
        wasm.wasmemu_load(this.ptr, addHeapObject(data));
    }
    /**
    * @param {number} scale
    */
    draw_screen(scale) {
        wasm.wasmemu_draw_screen(this.ptr, scale);
    }
}
